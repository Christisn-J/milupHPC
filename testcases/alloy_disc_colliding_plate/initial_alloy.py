...
# Funktionen ===================================================================================================
def find_sml_for_target_neighbors(tree, positions, target_range=(150, 180), h_initial=0.001, dim=2, tol=1):
    """
...
def generate_cube_particles(edge_length, velocity, mass, material_id, density, center=None, delta=1e-3, dim=2):
    """
    ...
    return particles
def generate_sphere_particles(radius, velocity, mass, material_id, density, center=None, delta=1e-3, dim=2):
    """
...
if __name__ == '__main__':
    ...
    parser.add_argument("-d", "--dimensions", type=int, choices=[1, 2, 3], default=2,help="Number of spatial dimensions (1, 2 or 3)")
